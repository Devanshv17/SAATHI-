                ...
                RichText(
                  ...
                  text: TextSpan(
                    ...
                    children: [
                      ...
                      TextSpan(
                        text: isHindi
                            ? 'प्रथम पीढ़ी के शिक्षार्थियों (first-generation learners), जिनकी औपचारिक शिक्षा तक पहुँच सीमित है, उन्हें सशक्त बनाने के लिए "साथी" (SAATHI) एक नि:शुल्क, मनोरंजक और संवादात्मक शिक्षण अनुभव प्रदान करता है। "साथी" खेल-आधारित गतिविधियों के माध्यम से हिंदी और अंग्रेजी में आवश्यक विषयों और अवधारणाओं को सरल बनाता है।\n\n'
                            : 'To empower pre-primary children, especially first-generation learners with limited access to formal education, by offering a free, fun, and interactive learning experience. SAATHI simplifies essential subjects and concepts using game-based activities in Hindi and English.\n\n',
                      ),
                      TextSpan(
                        text: isHindi
                      ...
                      TextSpan(
                        text: isHindi
                            ? 'साथी पाठों को छोटे, मजेदार खेलों में बदल देता है जो बच्चों का ध्यान बनाए रखते हैं और सीखने को आनंदमय बनाते हैं। इसमें ड्रैग-एंड-ड्रॉप, अक्षर मिलान और पैटर्न पहचान जैसे खेल शामिल हैं।\n\n'
                      ...
                      TextSpan(
                        text: isHindi
                            ...
                            : 'Designed especially for first-time digital users, SAATHI features a simple and intuitive interface, making it easy for young children to navigate without adult supervision.\n\n',
                      ),
                      TextSpan(
                        text: isHindi
                      ...
                      TextSpan(
                        text: isHindi
                            ? 'सभी खेल और निर्देश हिंदी और अंग्रेज़ी दोनों में उपलब्ध हैं, जिससे बच्चे अपनी पसंद की भाषा में सीख सकते हैं और धीरे-धीरे द्विभाषी क्षमता भी विकसित कर सकते हैं।\n\n'
                            : 'All games and instructions are available in both Hindi and English, allowing children to learn in their preferred language and gradually build bilingual confidence.\n\n',
                      ),
                      ...
                      TextSpan(
                        text: isHindi
                            ? 'इस खेल में बच्चों को किसी वस्तु का नाम पढ़कर उससे संबंधित सही चित्र पहचानना होता है। यह शब्दावली और दृश्य पहचान को बढ़ाता है।\n\n'
                            : 'Children are asked to match a word with its corresponding picture. This strengthens vocabulary and visual recognition.\n\n',
                      ),
                      ...
                      TextSpan(
                        text: isHindi
                            ? 'बच्चों को एक तस्वीर दिखाई जाती है, और उन्हें उस शब्द का पहला अक्षर बताना होता है जिसे वह तस्वीर दर्शाती है। यह वर्णमाला की समझ और एकाग्रता को बढ़ाता है।\n\n'
                            : 'Children are shown a picture, and they must guess the first letter of the word it represents. This sharpens alphabet recognition and focus.\n\n',
                      ),
                      ...
                      TextSpan(
                        text: isHindi
                            ...
                            : 'Children compare the quantity of two objects. This helps develop analytical and logical thinking.\n\n',
                      ),
                      ...
                      TextSpan(
                        text: isHindi
                            ...
                            : 'Children count the objects shown in pictures and select the correct number. This strengthens early math skills.\n\n',
                      ),
                      ...
                      TextSpan(
                        text: isHindi
                            ? 'इस गतिविधि में संख्या-शब्दों को उनके अंकों से जोड़ा जाता है, जिससे संख्याओं की मूलभूत समझ विकसित होती है।\n\n'
                            : 'In this activity, number names are matched with their digits, reinforcing basic number understanding.\n\n',
                      ),
                      ...
                      TextSpan(
                        text: isHindi
                            ? 'यह खेल बच्चों को अक्षरों की पहचान करने और वर्णमाला का क्रम समझने में मदद करता है।\n\n'
                            : 'This game helps children identify letters and understand the order of the alphabet.\n\n',
                      ),
                      ...
                      TextSpan(
                        text: isHindi
                            ? 'बच्चे विभिन्न वस्तुओं की स्थिति (बाएँ, दाएँ, मध्य) पहचानते हैं। यह स्थानिक समझ को बढ़ाता है।\n\n'
                      ...
                      TextSpan(
                        text: isHindi
                            ? 'बच्चे विभिन्न ज्यामितीय आकृतियों की पहचान करने और उनके नाम सीखने का अभ्यास करते हैं।\n\n'
                            : 'Children practice recognizing geometric shapes and learning their names.\n\n',
                      ),

                      TextSpan(
                        text: isHindi
                            ? '🙍‍♂️ आपके खाते के बारे में\n\n'
                      ...
                      TextSpan(
                        text: isHindi
                            ? "साथी ऐप में, आपकी प्रोफ़ाइल में आपका नाम, उम्र, लिंग और कक्षा की जानकारी दिखाई देती है। यह जानकारी आपकी सीखने की यात्रा को वैयक्तिक बनाने में मदद करती है और ऐप को आपके स्तर के अनुसार उपयुक्त खेल और सामग्री दिखाने में मदद करती है। यह जानकारी केवल आपके डिवाइस तक सीमित रहती है और किसी भी बाहरी उपयोग के लिए साझा नहीं की जाती।\n\n"
                            : "In the SAATHI app, your profile shows your name, age, gender, and class. This helps personalize your learning journey and lets the app show content and games suited to your level. All information stays on your device and is not shared externally in any form.\n\n",
                      ),
                      ...
                      TextSpan(
                        text: isHindi
                            ? 'यदि आप अपना खाता हटाना चाहते हैं, तो नीचे दिए गए बटन का उपयोग कर सकते हैं। यह आपकी प्रोफ़ाइल जानकारी और लॉगिन पहचान दोनों को स्थायी रूप से हटा देगा। यह प्रक्रिया अपरिवर्तनीय है, इसलिए कृपया सावधानी से निर्णय लें।'
                            : 'If you wish to delete your account, use the button below. This will permanently delete both your profile data and authentication credentials. This action is irreversible, so please proceed with caution.',
                      ),
                    ],
                  ),
                ),
