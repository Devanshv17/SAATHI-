          ...
          children: [
            Expanded(
              child: Text(
                widget.gameTitle,
                style:
                    const TextStyle(fontSize: 22, fontWeight: FontWeight.bold, fontFamily: 'MyCustomFont', color: Color.fromARGB(255, 245, 255, 255)),
              ),
            ),
            IconButton(
              icon: const Icon(Icons.info_outline, size: 28, color: Color.fromARGB(255, 245, 255, 255),),
