    ...
    return Form(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          _buildField(_ageController,   isHindi ? 'आयु'  : 'Age',        Icons.calendar_today, isNumber: true),
          const SizedBox(height: 16),
          DropdownButtonFormField<String>(
            ...
            items: ['Male', 'Female', 'Other']
                ...
                value: g,
                child: Text(isHindi ? _translateGender(g) : g)))
                .toList(),
          ...
          if (_goToSchool) ...[
            ...
            _buildField(_classController, isHindi ? 'कक्षा' : 'Class', Icons.school),
          ],
          const SizedBox(height: 15),
          Wrap(
